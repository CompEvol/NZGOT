...
//        createXML(out, ids);
    ...
    public static void createXML(PrintStream out, String[] ids, String beastHead, String alignments,
        ...
        for (String id : ids) {
            out.print(getCoalescent(id, ids[0]));
        }
        out.println();
        out.flush();

        out.print(getOtherPriors(ids[0]));
        out.println();
        out.flush();
    ...
    private static String getCoalescent(String id, String idref) {
    ...
    private static String getOtherPriors(String firstId){
