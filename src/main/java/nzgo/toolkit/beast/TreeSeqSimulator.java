...
//        intervals.initByName("tree", tree);
    ...
    public static void main(String[] args) {
        ...
        //====== 1st simulation
        Path outPath = Paths.get(workPath, "403gene6t0sim.xml");
...
//        mutationRate = 1.0;
        ...
        outPath = Paths.get(workPath, "403gene6t716sim.xml");
        try {
            outFile = new PrintStream(outPath.toFile());
        } catch (FileNotFoundException e) {
            e.printStackTrace();
...
//        mutationRate = 1.0;
    ...
    // create xml
    private static void createXML(PrintStream outFile, BufferedReader reader, double popSize, String[] taxa,
