...
public class rtest {
    public static void main(String[] args) {
        // need copy /Library/Frameworks/R.framework/Resources/library/rJava/jri/libjri.jnilib to /usr/lib/java
        MyLogger.debug(System.getProperty("java.library.path"));
...
//        try {
//            Process p = Runtime.getRuntime().exec(new String[]{"bash","export R_HOME=/Library/Frameworks/R.framework/Resources"});
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
        SystemUtil.printSysEnvVars();
