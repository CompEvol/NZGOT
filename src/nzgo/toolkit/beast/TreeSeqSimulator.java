...
//        freqs.initByName("frequencies", f, "estimate", false);
    ...
    public static void main(String[] args) {
        Path workPath = Paths.get(System.getProperty("user.home"),
                "BEAST2/Adelie/simulation/ConstantPopulation", NUM_GENES + "g10k6t");
        if (args.length == 1) {
...
//        mutationRate = 1.0;
    ...
    // create xml
    private static void createXML(Path workPath, String outFileName, String[] genes, int sequenceLength, double popSize,
        ...
        Path outTreePath = Paths.get(workPath.toString(), treeFileName);
        ...
        // xml file
        Path outPath = Paths.get(workPath.toString(), outFileName);
        ...
        outFile.println(xmlGenerator.getTaxonSet(taxa));
