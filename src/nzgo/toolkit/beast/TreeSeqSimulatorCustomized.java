 ...
 * @author Walter Xie
 */
public class TreeSeqSimulatorCustomized {

    private final static PrintStream out = System.out;

    public TreeSeqSimulatorCustomized() {
    }
...
//        mutationRate = 1.0;
        ...
        //====== 3rd simulation
        inPath = Paths.get(workPath, "403gene6t716.xml"); // 403gene6t0sim.xml, 403gene6t716sim.xml
        try {
...
//        mutationRate = 1.0;
    ...
    // create xml
    private static void createXML(String workPath, String outFileName, BufferedReader reader, double popSize, String[] taxa,
                                 int[] dates, double clockRate, double mutationRate, double kappa, double gammaShape) {
        ...
        // print data
        for (String id : ids) {
            TreeSeqSimulatorCustomized treeSeqSimulator = new TreeSeqSimulatorCustomized();
            try {
...
//                out.println(sXML);
        ...
        try {
            ...
            while (line != null) {
                ...
                if (copy) { // copy the last part of xml
